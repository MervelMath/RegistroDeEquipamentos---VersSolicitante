    ...
    class Program
    {
        ...
        */
        ...
        static void Main(string[] args)
        {
            ...
            ControladorSolicitante controladorSolicitante = new ControladorSolicitante(controladorChamado);

            TelaPrincipal telaPrincipal = new TelaPrincipal(
                controladorEquipamento, telaEquipamento, controladorChamado, telaChamado, controladorSolicitante);
